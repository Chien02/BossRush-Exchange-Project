...
func get_state():
	...
	if (Global.player_ek_mode.ek_mode == true and tranformation == false):
		set_up_ek_mode(true)
		tranformation = true
		print("tranformation: ", tranformation)
	elif (_state_name == "idle"): set_up_idle(true)
...
func get_direction(direction):
	if (direction != Vector2.ZERO):
		...
		animation_tree["parameters/ek_idle/blend_position"] = direction
		animation_tree["parameters/ek_attack/blend_position"] = direction
...
func set_up_idle(value):
	...
	animation_tree["parameters/conditions/ek_change"] = not value
...
func set_up_ek_mode(value):
	animation_tree["parameters/conditions/ek_change"] = value
	animation_tree["parameters/conditions/attack"] = not value
	animation_tree["parameters/conditions/dash"] = not value
	animation_tree["parameters/conditions/is_moving"] = not value
	animation_tree["parameters/conditions/idle"] = not value
